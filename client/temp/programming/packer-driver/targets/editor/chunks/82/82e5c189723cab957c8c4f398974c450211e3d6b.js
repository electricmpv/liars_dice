    ...
    execute: function () {
      ...
      _export("RoomUI", RoomUI = (_dec = ccclass('RoomUI'), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Button), _dec6 = property(Label), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Button), _dec(_class = (_class2 = class RoomUI extends Component {
        ...
        onLoad() {
          ...
          const initialState = (_crd && NetworkManager === void 0 ? (_reportPossibleCrUseOfNetworkManager({
            error: Error()
        ...
        handleStateChange(state) {
          ...
          let playerCount = 0;
          let playersList = []; // 检查 players 对象是否存在
          ...
          if (data.players && Array.isArray(data.players)) {
            ...
            data.players.forEach(pData => {
              ...
              if (pData && typeof pData === 'object' && pData.hasOwnProperty('id')) {
                // 创建新的 PlayerState 实例
                const playerState = new (_crd && PlayerState === void 0 ? (_reportPossibleCrUseOfPlayerState({
                  error: Error()
        ...
        updateReadyButtonInternal() {
          ...
          if (this.readyButton) {
            ...
            const isWaiting = ((_this$_colyseusState2 = this._colyseusState) == null ? void 0 : _this$_colyseusState2.status) === 'waiting';
        ...
        updateStartGameButtonInternal() {
          ...
          const isWaiting = ((_this$_colyseusState3 = this._colyseusState) == null ? void 0 : _this$_colyseusState3.status) === 'waiting'; // Check if conditions are met using UIUpdater's method

          const canStart = this.uiUpdater.checkIfCanStartGame(this._isHost, this._colyseusState); // Update button state (active and interactable) via UIUpdater
        ...
        onStartGameClick() {
          ...
          const currentIsWaiting = ((_this$_colyseusState5 = this._colyseusState) == null ? void 0 : _this$_colyseusState5.status) === 'waiting'; // Use correct check
        ...
        onQuickInviteAI() {
          ...
          const isWaiting = ((_this$_colyseusState6 = this._colyseusState) == null ? void 0 : _this$_colyseusState6.status) === 'waiting';
          ...
          const currentSize = (_this$_colyseusState7 = this._colyseusState) != null && _this$_colyseusState7.players ? Object.keys(this._colyseusState.players).length : 0;
          ...
          this.scheduleOnce(() => {
            ...
            const currentIsWaiting = ((_this$_colyseusState8 = this._colyseusState) == null ? void 0 : _this$_colyseusState8.status) === 'waiting'; // Check player count using Object.keys length

            const currentSizeAfterWait = (_this$_colyseusState9 = this._colyseusState) != null && _this$_colyseusState9.players ? Object.keys(this._colyseusState.players).length : 0;
