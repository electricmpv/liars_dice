    ...
    execute: function () {
      ...
      _export("ChatItem", ChatItem = (_dec = ccclass('ChatItem'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Sprite), _dec6 = property(Label), _dec7 = property(RichText), _dec8 = property(Label), _dec9 = property(Node), _dec(_class = (_class2 = class ChatItem extends Component {
        ...
        updateMessageSize() {
          ...
          const textSize = (_this$messageText$nod = this.messageText.node.getComponent(UITransform)) == null ? void 0 : _this$messageText$nod.contentSize;
        ...
        formatTime(timestamp) {
          ...
          const now = new Date(); // 如果是今天的消息，只显示时间
        ...
        playNewMessageAnimation() {
          ...
          const uiOpacity = this.node.getComponent(UIOpacity) || this.node.addComponent(UIOpacity); // 设置初始位置在下方
        ...
        playHighlightAnimation() {
          ...
          const originalColor = (_this$messageContaine = this.messageContainer) == null || (_this$messageContaine = _this$messageContaine.getComponent(Sprite)) == null ? void 0 : _this$messageContaine.color.clone();
