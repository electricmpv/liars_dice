System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _crd, nodeModules;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "011981F1m1B1KLstTQ/73mo", "node-polyfills", undefined);
              ...
              update: data => {
                return {
                  digest: encoding => {
                    // 简单实现，仅用于兼容性
                    if (encoding === 'hex') {
                      return Array.from(new TextEncoder().encode(String(data))).map(b => b.toString(16).padStart(2, '0')).join('');
                    }
...
//# sourceMappingURL=7c5882169485e8addd9c7b64a4bb955e965e2773.js.map