      ...
      _export("FriendRequest", FriendRequest = (_dec = ccclass('FriendRequest'), _dec2 = property(_crd && PlayerItem === void 0 ? (_reportPossibleCrUseOfPlayerItem({
        ...
        startCountdown() {
          ...
          this._countdownTimer = setInterval(() => {
            var elapsedTime = Math.floor((Date.now() - this._requestTime) / 1000);
            var remainingTime = this._expirationTime - elapsedTime;
        ...
        playHideAnimation() {
          var uiOpacity = this.node.getComponent(UIOpacity) || this.node.addComponent(UIOpacity); // 向右滑出并淡出
