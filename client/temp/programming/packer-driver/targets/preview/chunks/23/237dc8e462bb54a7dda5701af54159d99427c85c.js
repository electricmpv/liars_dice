      ...
      _export("GameHistoryPanel", GameHistoryPanel = (_dec = ccclass('GameHistoryPanel'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(ScrollView), _dec(_class = (_class2 = class GameHistoryPanel extends Component {
        ...
        handleHistoryUpdated(data) {
          ...
          data.items.forEach(item => {
            ...
            var historyNodeInstance = instantiate(this.historyItemPrefab);
            ...
            var labelNode = historyNodeInstance.getChildByName("HistoryLabel");
            var label = labelNode == null ? void 0 : labelNode.getComponent(Label);
          ...
          this.scheduleOnce(() => {
            if (this.scrollView) {
              ...
              var parentScrollView = this.node.getComponent(ScrollView) || ((_this$node$getParent = this.node.getParent()) == null ? void 0 : _this$node$getParent.getComponent(ScrollView));
