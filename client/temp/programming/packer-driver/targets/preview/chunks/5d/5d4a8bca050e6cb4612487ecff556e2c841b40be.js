    ...
    execute: function () {
      ...
      _export("GameResultPanel", GameResultPanel = (_dec = ccclass('GameResultPanel'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(_crd && PlayerDisplayController === void 0 ? (_reportPossibleCrUseOfPlayerDisplayController({
        ...
        onDestroy() {
          ...
          // }
          // 移除按钮点击事件，防止访问已销毁的节点
          var btnNode = (_this$backToLobbyButt = this.backToLobbyButton) == null ? void 0 : _this$backToLobbyButt.node;
        ...
        showResult(data) {
          ...
          if (this.winnerLabel) {
            ...
            var winnerName = ((_this$playerDisplayCo = this.playerDisplayController) == null ? void 0 : _this$playerDisplayCo.getPlayerNameWithAlias(data.winner)) || data.winner;
        ...
        calculateAndShowFinalScore(data) {
          ...
          var scoreText = "最终得分:\n";
          var sortedPlayers = [...data.players].sort((a, b) => {
          ...
          sortedPlayers.forEach((player, index) => {
            ...
            var playerName = ((_this$playerDisplayCo2 = this.playerDisplayController) == null ? void 0 : _this$playerDisplayCo2.getPlayerNameWithAlias(player.id)) || "\u73A9\u5BB6 " + player.id.substring(0, 4);
            var diceCount = typeof player.diceCount === 'number' ? player.diceCount : '?'; // Handle missing diceCount
