  ...
  return {
    ...
    execute: function () {
      ...
      _export("FilterTab", FilterTab = (_dec = ccclass('FilterTab'), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Button), _dec(_class = (_class2 = class FilterTab extends Component {
        ...
        setSelected(selected, fireEvent) {
          if (fireEvent === void 0) {
            fireEvent = false;
          }
        ...
        playSelectionAnimation() {
          if (this._isSelected) {
            ...
            if (this.indicator) {
              ...
              var uiOpacity = this.indicator.getComponent(UIOpacity) || this.indicator.addComponent(UIOpacity);
              uiOpacity.opacity = 0;
            ...
            // 取消选中动画
            if (this.indicator) {
              var _uiOpacity = this.indicator.getComponent(UIOpacity) || this.indicator.addComponent(UIOpacity);

              tween(_uiOpacity).to(0.2, {
                opacity: 0
              }).call(() => {
