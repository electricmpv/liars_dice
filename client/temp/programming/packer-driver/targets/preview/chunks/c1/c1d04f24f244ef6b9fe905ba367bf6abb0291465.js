    ...
    execute: function () {
      ...
      _export("UIUpdater", UIUpdater = class UIUpdater {
        ...
        players, currentSessionId, hostId) {
          ...
          try {
            ...
            if (typeof players.forEach === 'function') {
              ...
              players.forEach((playerData, key) => {
                ...
                var sessionId = playerData.sessionId || key;
              ...
              var playersList = Object.values(players);
              playersList.forEach(playerData => {
                // 使用 sessionId 作为标识符
                var sessionId = playerData.sessionId || '';
                this.createPlayerItem(playerListContent, playerItemPrefab, sessionId, playerData, currentSessionId, hostId);
              });
            }
          } catch (error) {
          ...
          var layout = playerListContent.getComponent(Layout);
        ...
        createPlayerItem(parent, prefab, sessionId, playerData, currentSessionId, hostId) {
          ...
          var playerNode = instantiate(prefab);
          ...
          if (playerComp) {
            ...
            var isSelf = sessionId === currentSessionId;
        ...
        checkIfCanStartGame(isHost, state) {
          ...
          var activeConnectedPlayerCount = 0;
          var allReady = true;
          var activePlayersLog = []; // For logging
        ...
        showError(statusLabel, message, persistent, component) {
          ...
          if (statusLabel && statusLabel.node && statusLabel.node.isValid) {
            ...
            var timerKey = 'statusLabelHideTimer_Error'; // Unique key

            var nodeWithTimer = statusLabel.node; // Clear previous timer if exists using the component's scheduler
        ...
        showInfo(statusLabel, message, persistent, component) {
          if (persistent === void 0) {
            persistent = false;
          }
          ...
          if (statusLabel && statusLabel.node && statusLabel.node.isValid) {
            ...
            statusLabel.node.active = true;
            var timerKey = 'statusLabelHideTimer_Info'; // Unique key
