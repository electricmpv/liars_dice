  ...
  return {
    ...
    execute: function () {
      ...
      _export("SystemNotice", SystemNotice = (_dec = ccclass('SystemNotice'), _dec2 = property(Label), _dec3 = property(Sprite), _dec4 = property(Node), _dec5 = property([SpriteFrame]), _dec6 = property(Button), _dec7 = property(Label), _dec8 = property(Node), _dec(_class = (_class2 = class SystemNotice extends Component {
        ...
        show(text, type, duration, isPersistent, confirmText, noticeId, noticeData) {
          ...
          var bgSprite = (_this$background = this.background) == null ? void 0 : _this$background.getComponent(Sprite);
          ...
          if (!this.persistent) {
            var hideTime = duration !== undefined ? duration : this.autoHideDuration;
        ...
        playHideAnimation() {
          ...
          var uiOpacity = this.node.getComponent(UIOpacity) || this.node.addComponent(UIOpacity); // 向上滑出并淡出
